						...
						<div class="accordion" id="accordionExample">
							<div class="accordion-item">
								<h4 class="accordion-header" id="headingOne">
									<button  class="accordion-button collapsed text-uppercase"   type="button"  data-bs-toggle="collapse"  data-bs-target="#collapseOne"  aria-expanded="false" aria-controls="collapseOne">Сколько времени требуется на производство и установку шкафа-купе?</button>
								</h4>
								<div  id="collapseOne"  class="accordion-collapse collapse"  aria-labelledby="headingOne"  data-bs-parent="#accordionExample">
									<div class="accordion-body">Мы не обещаем сделать шкаф-купе за день, два, три или даже 5 дней. МЫ НЕ ВВОДИМ НАШИХ КЛИЕНТОВ В ЗАБЛУЖДЕНИЕ. ОТ ЗАКАЗА ДО УСТАНОВКИ ШКАФА В СРЕДНЕМ ПРОХОДИТ 1,5-2 НЕДЕЛИ, ПОСЛЕ ЧЕГО МЫ ПРИВЕЗЕМ И УСТАНОВИМ ШКАФ ОДНИМ ДНЕМ.</div>
								</div>
							</div>
							<div class="accordion-item">
