            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-7 offset-lg-1">
						<h1><span>Распашные шкафы </span> на&nbsp;заказ от&nbsp;производителя<span><?php echo $location; ?></span></h1>
						<ul class="main-list">
							<li>
								<div class="row">
								...
								<div class="accordion" id="accordionExample">
									<div class="accordion-item">
										<h4 class="accordion-header" id="headingOne">
											<button  class="accordion-button collapsed text-uppercase"   type="button"  data-bs-toggle="collapse"  data-bs-target="#collapseOne"  aria-expanded="false" aria-controls="collapseOne">Сколько времени требуется на производство и установку распашного шкафа?</button>
										</h4>
										<div  id="collapseOne"  class="accordion-collapse collapse"  aria-labelledby="headingOne"  data-bs-parent="#accordionExample">
											<div class="accordion-body text-uppercase">Мы не обещаем сделать шкаф за день, два, три или даже 5 дней. Мы не вводим наших клиентов в заблуждение. От заказа до установки распашного шкафа в среднем проходит 1,5-2 недели, после чего мы привезем и установим шкаф-купе одним днем.</div>
										</div>
									</div>
									<div class="accordion-item">
										...
										<div  id="collapseTwo"  class="accordion-collapse collapse"  aria-labelledby="headingTwo"  data-bs-parent="#accordionExample">
											<div class="accordion-body">Мы делаем распашные шкафы и другую корпусную мебель с 2011 года. Имеем собственное производство, которое Вы можете посетить, чтобы убедиться, что мы сами изготавливаем все шкафы, а не поручаем это другим, а с Вас берем дополнительную наценку.</div>
										</div>
									</div>
									<div class="accordion-item">
									...
									<div class="accordion-item">
										...
										<div  id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#accordionExample">
											<div class="accordion-body">После замера и выбора материалов распашного шкафа мы сразу скажем Вам окончательную стоимость. Стоимость включает в себя изготовление, доставку и установку. Больше никаких скрытых платежей!</div>
										</div>
									</div>
