					...
					<div class="row">
                        <div class="col-lg-6">
                            <div class="row">
                                ...
                                <div class="col-10">
									<p class="mb-2">Для расчета опишите двери-купе своими словами. При возможности прикрепите изображение</p>
									<form  method="post"  action="<?php echo get_stylesheet_directory_uri(); ?>/mails/get_calculate.php" enctype="multipart/form-data">
										<textarea type="text" rows="3" name="mes" class="form-control" placeholder="Например: длина, ширина, глубина, количество дверей, материал дверей, форма, вид шкафа и т.д." style="height: auto;  margin-top: 15px;  margin-bottom: 15px;"></textarea>
										<p class="input-group custom-file-button">
                ...
                <div class="col-md-9">
					...
					<div class="row">
                        ...
                        <div class="col-lg-3 text-center step">
							...
							<p>Принятие Вами решения о заказе дверей купе у нас. Только здесь Вы вносите предоплату 30% по Договору (любой удобный для Вас способ предоплаты)</p>
                        </div>
                        <div class="col-lg-3 text-center step">
							...
							<div class="accordion" id="accordionExample">
								<div class="accordion-item">
									<h4 class="accordion-header" id="headingOne">
										<button  class="accordion-button collapsed text-uppercase"   type="button"  data-bs-toggle="collapse"  data-bs-target="#collapseOne"  aria-expanded="false" aria-controls="collapseOne">Сколько времени требуется на производство и установку дверей-купе?</button>
									</h4>
									<div  id="collapseOne"  class="accordion-collapse collapse"  aria-labelledby="headingOne"  data-bs-parent="#accordionExample">
										<div class="accordion-body text-uppercase">Мы не обещаем сделать дверь-купе за день, два, три или даже 5 дней. Мы не вводим наших клиентов в заблуждение. От заказа до установки дверей в среднем проходит 1-2 недели, после чего мы привезем и установим дверь-купе одним днем.</div>
									</div>
								</div>
								<div class="accordion-item">
									...
									<div  id="collapseTwo"  class="accordion-collapse collapse"  aria-labelledby="headingTwo"  data-bs-parent="#accordionExample">
										<div class="accordion-body">Мы делаем шкафы-купе и другую корпусную мебель с 2011 года. Имеем собственное производство, которое Вы можете посетить, чтобы убедиться, что мы сами изготавливаем все шкафы, а не поручаем это другим, а с Вас берем дополнительную наценку.</div>
									</div>
								</div>
								<div class="accordion-item">
								...
								<div class="accordion-item">
									...
									<div  id="collapseFour"  class="accordion-collapse collapse"  aria-labelledby="headingFour"  data-bs-parent="#accordionExample">
										<div class="accordion-body">Мы работаем с ведущими производителями, обладающими большой палитрой цветов и высоким качеством ЛДСП, такими как EGGER и Русский ламинат. Профиль для дверей мы используем Aristo, Italum и Inlux.</div>
									</div>
								</div>
								...
								<div class="accordion-item">
									...
									<div  id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#accordionExample">
										<div class="accordion-body">После замера и выбора материалов дверей-купе мы сразу скажем Вам окончательную стоимость. Стоимость включает в себя изготовление, доставку и установку. Больше никаких скрытых платежей!</div>
									</div>
								</div>
